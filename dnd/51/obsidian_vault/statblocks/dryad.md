...
- _**Innate Spellcasting.**_ The dryad's innate spellcasting ability is Charisma (spell save DC 14). The dryad can innately cast the following spells, requiring no material components:
    ...
    - 3/day each: [[entangle|Entangle]], [[goodberry|Goodberry]]
    - 1/day each: [[barkskin|Barkskin]], [[pass_without_trace|Pass Without Trace]], [[shillelagh|Shillelagh]]
...
- _**Club.** Melee Weapon Attack:_ +2 to hit (+6 to hit with [[shillelagh|Shillelagh]]), reach 5 ft., one target. _Hit:_ 2 (1d4) bludgeoning damage, or 8 (1d8 + 4) bludgeoning damage with [[shillelagh|Shillelagh]].
