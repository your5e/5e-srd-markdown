...
The DC is 15 to spot the pressure plate, as well as faint scorch marks on the floor and walls. A spell or other effect that can sense the presence of magic, such as [[detect_magic|Detect Magic]], reveals an aura of evocation magic around the statue.
...
Wedging an iron spike or other object under the pressure plate prevents the trap from activating. A successful [[dispel_magic|Dispel Magic]] (DC 13) cast on the statue destroys the trap.
