...
| **Modifier**     |     +3 |     +2 |     +2 |     -4 |     +1 |     -1 |
| **Saving Throw** |     +3 |     +2 |     +2 |     -4 |     +1 |     -1 |
...
_**Bite.**_ _Melee Weapon Attack:_ +5 to hit, reach 5 ft., one target. _Hit:_ 8 (1d10 + 3) piercing damage.

_**Claw.**_ _Melee Weapon Attack:_ +5 to hit, reach 5 ft., one target. _Hit:_ 7 (1d8 + 3) slashing damage.
