...
_**Bite.**_ _Melee Weapon Attack:_ +7 to hit, reach 5 ft., one target. _Hit:_ 22 (4d8 + 4) piercing damage.

_**Tendril.**_ _Melee Weapon Attack:_ +7 to hit, reach 50 ft., one creature. _Hit:_ The target is [[Grappled]] (escape DC 15). Until the grapple ends, the target is [[Restrained]] and has disadvantage on Strength checks and Strength saving throws, and the roper can't use the same tendril on another target.
