...
| **Modifier**     |     +2 |     +2 |     +1 |     -2 |     +0 |     -2 |
| **Saving Throw** |     +2 |     +2 |     +1 |     -2 |     +0 |     -2 |
...
_**Ethereal Jaunt.**_ As a bonus action, the spider can magically shift from the Material Plane to the Ethereal Plane, or vice versa.
