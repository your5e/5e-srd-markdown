...
_**Innate Spellcasting (1/Day).**_ The mephit can innately cast [[Fog Cloud]], requiring no material components. Its innate spellcasting ability is Charisma.

## Actions

_**Claws.**_ _Melee Weapon Attack:_ +3 to hit, reach 5 ft., one creature. _Hit:_ 3 (1d4 + 1) slashing damage plus 2 (1d4) cold damage.
