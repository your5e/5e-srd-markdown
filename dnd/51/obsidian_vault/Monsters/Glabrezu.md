...
_**Pincer.**_ _Melee Weapon Attack:_ +9 to hit, reach 10 ft., one target. _Hit:_ 16 (2d10 + 5) bludgeoning damage. If the target is a Medium or smaller creature, it is [[Grappled]] (escape DC 15). The glabrezu has two pincers, each of which can grapple only one target.

_**Fist.**_ _Melee Weapon Attack:_ +9 to hit, reach 5 ft., one target. _Hit:_ 7 (2d4 + 2) bludgeoning damage.
