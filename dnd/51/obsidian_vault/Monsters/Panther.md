...
| **Modifier**     |     +2 |     +2 |     +0 |     -4 |     +2 |     -2 |
| **Saving Throw** |     +2 |     +2 |     +0 |     -4 |     +2 |     -2 |
...
_**Bite.**_ _Melee Weapon Attack:_ +4 to hit, reach 5 ft., one target. _Hit:_ 5 (1d6 + 2) piercing damage.

_**Claw.**_ _Melee Weapon Attack:_ +4 to hit, reach 5 ft., one target. _Hit:_ 4 (1d4 + 2) slashing damage.
