...
_**Bite.**_ _Melee Weapon Attack:_ +8 to hit, reach 5 ft., one creature. _Hit:_ 8 (1d6 + 5) piercing damage, and the target must succeed on a DC 13 Constitution saving throw or be [[Poisoned]] for 24 hours. Until this poison ends, the target is [[Unconscious]]. Another creature can use an action to shake the target awake.

_**Constrict.**_ _Melee Weapon Attack:_ +6 to hit, reach 10 ft., one Medium or smaller creature. _Hit:_ 10 (2d6 + 3) bludgeoning damage, and the target is [[Grappled]] (escape DC 15). Until this grapple ends, the target is [[Restrained]], and the couatl can't constrict another target.
