...
| **Modifier**     |     +2 |     +0 |     +2 |     -2 |     +1 |     -2 |
| **Saving Throw** |     +2 |     +0 |     +2 |     -2 |     +1 |     -2 |
...
_**Beak.**_ _Melee Weapon Attack:_ +4 to hit, reach 5 ft., one target. _Hit:_ 7 (2d4 + 2) piercing damage.

_**Talons.**_ _Melee Weapon Attack:_ +4 to hit, reach 5 ft., one target. _Hit:_ 9 (2d6 + 2) slashing damage.
