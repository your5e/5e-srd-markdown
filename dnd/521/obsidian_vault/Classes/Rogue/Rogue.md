...
- Gain the Rogue's level 1 features, which are listed in the Rogue Class Features table.
...
As a Rogue, you gain the following class features when you reach the specified Rogue levels.
