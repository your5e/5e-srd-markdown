...
On a failed save, the target has [[Disadvantage]] on Strength-based [[D20 Test]]s for the duration. During that time, it also subtracts 1d8 from all its damage rolls. The target repeats the save at the end of each of its turns, ending the spell on a success.
