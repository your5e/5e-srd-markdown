...
Each ability has a modifier that you apply whenever you make a D20 Test with that ability (explained in "[[D20 Test]]s"). An ability modifier is derived from its score.
