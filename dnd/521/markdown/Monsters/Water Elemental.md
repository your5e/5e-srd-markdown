...
_**Freeze.**_ If the elemental takes Cold damage, its Speed decreases by 20 feet until the end of its next turn.
...
_**Slam.**_ _Melee Attack Roll:_ +7, reach 5 ft. _Hit:_ 13 (2d8 + 4) Bludgeoning damage. If the target is a Medium or smaller creature, it has the Prone condition.
