...
_**Quarterstaff.**_ _Melee Weapon Attack:_ +2 to hit (+4 to hit with _Shillelagh_), reach 5 ft., one target. _Hit:_ 3 (1d6) bludgeoning damage, 4 (1d8) bludgeoning damage if wielded with two hands, or 6 (1d8 + 2) bludgeoning damage with _Shillelagh_.
